...
class Breadcrumbs {
    ...
    constructor(vueApp) {
        ...
        this.value = vue.reactive([]); // breadcrumbs array
    }
    init() {
...
var breadcrumbs = {
    install: (app, options) => {
        ...
        if (options?.includeComponent) {
            const AmBreadcrumbs = vue.defineAsyncComponent(() => Promise.resolve().then(function () { return require('./AmBreadcrumbs-8489d1fe.js'); }));
