      ...
      _push(ssrRenderComponent(VCard, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="product--icon__wrapper bg-secondary" data-v-bbc13de1${_scopeId}>`);
            _push2(ssrRenderComponent(_component_nuxt_img, {
              provider: "strapi",
              width: 60,
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(VBtn, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<span class="text-secondary" data-v-bbc13de1${_scopeId3}>\u041F\u043E\u0434\u0440\u043E\u0431\u043D\u0435\u0435</span>`);
                      } else {
                        return [
...
const ProductCard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-bbc13de1"]]);

export { ProductCard as P, Z, be as b };
//# sourceMappingURL=ProductCard-7bf31a6d.mjs.map
