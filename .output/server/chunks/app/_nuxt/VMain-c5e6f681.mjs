import { createVNode, Transition, mergeProps, toRef, shallowRef, computed, ref, watch, withDirectives, vShow, Fragment, resolveDirective, reactive, Teleport, inject, provide, useSSRContext, readonly, toRaw, watchEffect, nextTick, effectScope, onScopeDispose, warn, resolveComponent, withCtx, unref, toDisplayString, openBlock, createBlock, renderList, createTextVNode, getCurrentScope, defineComponent as defineComponent$1, h, getCurrentInstance as getCurrentInstance$1 } from 'vue';
import { hasProtocol, parseURL, parseQuery, withTrailingSlash, withoutTrailingSlash } from 'ufo';
import { d as genericComponent, h as defineStore, p as propsFactory, m as makeThemeProps, j as provideTheme, k as useRtl, l as provideDefaults, a as convertToUnit, q as useProxiedModel, r as useToggleScope, I as IconValue, E as EventProp, t as deprecate, C as omit, b as getUid, _ as _export_sfc, g as getCurrentInstance, f as findChildrenWithProvide, o as clamp, s as defineComponent, v as focusChild, A as refElement, B as IN_BROWSER, D as useNuxtApp, F as useDisplay, i as isOn, e as eventName, y as destructComputed, w as getPropertyFromItem, x as pick, z as consoleError, u as useRouter$1, n as navigateTo } from '../server.mjs';
...
export { FooterComponent as F, HeaderComponent as H, VApp as V, VMain as a };
//# sourceMappingURL=VMain-c5e6f681.mjs.map
