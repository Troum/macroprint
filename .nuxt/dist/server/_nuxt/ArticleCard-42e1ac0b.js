...
import { V as VCard, a as VCardSubtitle, b as VCardTitle, c as VCardText } from "./VCard-2fc4bd81.js";
const ArticleCard_vue_vue_type_style_index_0_scoped_60556e97_lang = "";
const _sfc_main = {
  __name: "ArticleCard",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(VCard, mergeProps({
        to: `/company/articles/${__props.article["slug"]}`,
        elevation: 0,
        height: 567,
        class: "pa-0",
        color: "white",
            ...
            _push2(ssrRenderComponent(VCardSubtitle, { class: "article--subtitle" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<span data-v-60556e97${_scopeId2}>${ssrInterpolate(__props.article["date"])}</span>`);
                } else {
                  return [
...
const ArticleCard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-60556e97"]]);
export {
  ArticleCard as A
};
//# sourceMappingURL=ArticleCard-42e1ac0b.js.map
